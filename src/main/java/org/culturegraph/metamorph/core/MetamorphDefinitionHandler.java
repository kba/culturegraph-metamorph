...
final class MetamorphDefinitionHandler implements 	ContentHandler{
	...
	//	private boolean doReprocess;
		...
		public void endElement(final String uri, final String localName, final String qName)
				throws SAXException {
			if (COLLECT_LITERAL_TAG.equals(localName)) {
				collect = null;
			}else if (GROUP_TAG.equals(localName)) {
				emitGroupName = null;
				emitGroupValue = null;
		 ...
		 * @param attributes
		 */
		private void registerFunction(final String name,
		...
		@Override
		public void endPrefixMapping(final String prefix) throws SAXException {/*do nothing*/}
		...
		@Override
		public void skippedEntity(final String name) throws SAXException {/*do nothing*/}

		@Override
		public void characters(final char[] cha, final int start, final int length)
				throws SAXException {/*do nothing*/}

		@Override
		public void ignorableWhitespace(final char[] cha, final int start, final int length)
				throws SAXException {/*do nothing*/}
