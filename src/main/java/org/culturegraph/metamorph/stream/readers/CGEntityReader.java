...
public final class CGEntityReader extends AbstractReader {
	...
	private static final Pattern FIELD_PATTERN = Pattern.compile(String.valueOf(CGEntity.FIELD_DELIMITER), Pattern.LITERAL);
	private static final Pattern SUBFIELD_PATTERN = Pattern.compile(String.valueOf(CGEntity.SUB_DELIMITER), Pattern.LITERAL);
